...
CREATE TABLE IF NOT EXISTS `carloan`.`fascia` (
	...
	`tariffa_giornaliera` DOUBLE(6, 2) UNSIGNED NOT NULL,
	`tariffa_settimanale` DOUBLE(6, 2) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `carloan`.`contratto` (
	...
	`prezzo_km` DOUBLE(6, 2) UNSIGNED NOT NULL,
	...
	`acconto` DOUBLE(6, 2) UNSIGNED NOT NULL,
	`km_percorsi` DOUBLE(6, 2) UNSIGNED,
	`tariffa_base` DOUBLE(6, 2) UNSIGNED NOT NULL,
	`stato_contratto` ENUM('aperto', 'chiuso'),
	`totale` DOUBLE(6, 2) UNSIGNED,
	PRIMARY KEY (`id`),
